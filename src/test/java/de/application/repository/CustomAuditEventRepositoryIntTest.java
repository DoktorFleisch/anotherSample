package de.application.repository;

import de.application.AnotherSampleApp;
import de.application.config.Constants;
import de.application.config.audit.AuditEventConverter;
import de.application.domain.PersistentAuditEvent;
...
import static de.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
